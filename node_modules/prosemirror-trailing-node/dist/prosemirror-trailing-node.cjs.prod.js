...
function trailingNode(options) {
  ...
  var ignoredNodeNames = coreHelpers.uniqueArray([...ignoredNodes, nodeName]); // The node that will be inserted when the criteria match.
  ...
  return new prosemirrorState.Plugin({
    ...
    state: {
      init: (_, _ref2) => {
        ...
        return coreHelpers.includes(types, (_doc$lastChild = doc.lastChild) === null || _doc$lastChild === void 0 ? void 0 : _doc$lastChild.type);
      },
      apply: (tr, value) => {
        ...
        return coreHelpers.includes(types, (_tr$doc$lastChild = tr.doc.lastChild) === null || _tr$doc$lastChild === void 0 ? void 0 : _tr$doc$lastChild.type);
      }
    }
  });
}
