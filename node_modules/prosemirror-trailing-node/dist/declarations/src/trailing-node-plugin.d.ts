 ...
 */
export declare function trailingNode<Schema extends EditorSchema<string, string> = EditorSchema<string, string>>(options?: TrailingNodePluginOptions): Plugin<boolean, Schema>;
