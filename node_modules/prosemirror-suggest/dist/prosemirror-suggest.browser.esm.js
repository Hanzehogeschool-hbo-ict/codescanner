...
import { isString, includes, isObject, range, isRegExp, findMatches, isEmptyArray, object, sort, isFunction } from '@remirror/core-helpers';
...
var selectionExitReasons = [ExitReason.MoveEnd, ExitReason.MoveStart, ExitReason.SelectionOutside, ExitReason.JumpForward, ExitReason.JumpBackward];
/**
...
class SuggestState {
  ...
  constructor(_suggesters2) {
    ...
    _defineProperty(this, "addIgnored", _ref => {
      ...
      var offset = isString(suggester.char) ? suggester.char.length : 1;
      var to = from + offset;
  ...
  mapIgnoredDecorations(tr) {
    ...
    var invalid = decorations.filter(_ref4 => {
      var from = _ref4.from,
          to = _ref4.to,
          spec = _ref4.spec;
      var charLength = isString(spec.char) ? spec.char.length : 1;
