...
import type { AddIgnoredProps, EditorSchema, EditorState, EditorStateProps, EditorView, RemoveIgnoredProps, ResolvedPos, Suggester, SuggestMatch, Transaction, TransactionProps } from './suggest-types';
/**
 * The `prosemirror-suggest` state which manages the list of suggesters.
 */
export declare class SuggestState<Schema extends EditorSchema = EditorSchema> {
    #private;
    /**
     * Create an instance of the SuggestState class.
     */
    static create<Schema extends EditorSchema = EditorSchema>(suggesters: Array<Suggester<Schema>>): SuggestState<Schema>;
    /**
     ...
     */
    readonly clearIgnored: (name?: string | undefined) => void;
    /**
