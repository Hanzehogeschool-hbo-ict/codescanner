 ...
 */
export declare function getSuggestPluginState<Schema extends EditorSchema = EditorSchema>(state: EditorState<Schema>): SuggestState;
/**
 ...
 */
export declare function addSuggester<Schema extends EditorSchema = EditorSchema>(state: EditorState<Schema>, suggester: Suggester): () => void;
/**
 ...
 * object.
 */
export declare function removeSuggester<Schema extends EditorSchema = EditorSchema>(state: EditorState<Schema>, suggester: Suggester | string): void;
/**
