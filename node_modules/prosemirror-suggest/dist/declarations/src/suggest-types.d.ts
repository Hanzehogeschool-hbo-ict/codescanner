 ...
 *
 */
export interface SuggestMatch<Schema extends EditorSchema = EditorSchema> extends SuggesterProps<Schema> {
    /**
 ...
 */
export interface SuggestChangeHandlerProps<Schema extends EditorSchema = EditorSchema> extends SuggestMatchWithReason<Schema>, EditorViewProps<Schema>, SuggestIgnoreProps, SuggestMarkProps, Pick<Suggester<Schema>, 'name' | 'char'> {
}
/**
 ...
 * set to true.
 */
export declare type SuggestChangeHandler<Schema extends EditorSchema = EditorSchema> = (changeDetails: SuggestChangeHandlerProps<Schema>, tr: Transaction<Schema>) => void;
 ...
 * or an `exitReason`.
 */
export interface SuggestMatchWithReason<Schema extends EditorSchema = EditorSchema> extends SuggestMatch<Schema>, ReasonProps {
}
/**
