...
import type { CommandFunction, EditorSchema, NonChainableCommandFunction, ProsemirrorCommandFunction } from './pm-types';
/**
 ...
 * commands.
 */
export declare function chainableEditorState<Schema extends EditorSchema = EditorSchema>(tr: Transaction<Schema>, state: EditorState<Schema>): EditorState<Schema>;
/**
 ...
 */
export declare function convertCommand<Schema extends EditorSchema = EditorSchema, Extra extends object = object>(commandFunction: ProsemirrorCommandFunction<Schema>): CommandFunction<Schema, Extra>;
/**
 ...
 * ```
 */
export declare function nonChainable<Schema extends EditorSchema = EditorSchema, Extra extends object = object>(commandFunction: CommandFunction<Schema, Extra>): NonChainableCommandFunction<Schema, Extra>;
/**
 ...
 * true.
 */
export declare function chainCommands<Schema extends EditorSchema = EditorSchema, Extra extends object = object>(...commands: Array<CommandFunction<Schema, Extra>>): CommandFunction<Schema, Extra>;
