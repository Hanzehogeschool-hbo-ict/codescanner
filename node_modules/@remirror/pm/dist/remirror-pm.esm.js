...
import { object, invariant } from '@remirror/core-helpers';
...
function nonChainable(commandFunction) {
  return props => {
    ...
    !(props.dispatch === undefined || props.dispatch === ((_props$view = props.view) === null || _props$view === void 0 ? void 0 : _props$view.dispatch)) ? process.env.NODE_ENV !== "production" ? invariant(false, {
...
export { chainCommands, chainableEditorState, convertCommand, nonChainable };
