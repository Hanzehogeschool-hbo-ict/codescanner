...
import type { AnyConstructor, AnyFunction, CommandFunction, EditorSchema, EditorState, EditorStateProps, Except, GetDynamic, GetFixedDynamic, GetPartialDynamic, PrimitiveSelection, RemoveAnnotations, Transaction, ValidOptions } from '@remirror/core-types';
 ...
 */
export interface CreateExtensionPlugin<PluginState = any> extends Except<PluginSpec<PluginState, EditorSchema>, 'key'> {
}
/**
