 ...
 */
export declare type ShortcutMap = Record<NamedShortcut, string>;
/**
...
export declare type KeyboardShortcuts = keyof typeof keyboardShortcuts | ShortcutMap;
/**
 * KeyBindings as a tuple with priority and the keymap.
 */
export declare type KeyBindingsTuple = [priority: ExtensionPriority, bindings: KeyBindings];
/**
 * `KeyBindings` as an object or prioritized tuple.
 */
export declare type PrioritizedKeyBindings = KeyBindings | KeyBindingsTuple;
declare global {
    namespace Remirror {
