import type { AcceptUndefined, CommandFunction, CommandFunctionProps, EditorSchema, EditorState, EditorView, FromToProps, Handler, MakeRequired, Static } from '@remirror/core-types';
...
export declare type DecorationPlaceholder = WidgetPlaceholder | NodePlaceholder | InlinePlaceholder;
export interface DelayedPlaceholderCommandProps<Value> {
     ...
     */
    onFailure?: CommandFunction<EditorSchema, {
        error: any;
    }>;
}
declare global {
