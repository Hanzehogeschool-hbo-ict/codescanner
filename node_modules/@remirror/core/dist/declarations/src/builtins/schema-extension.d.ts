...
import { AnyExtension, GetMarkNameUnion, GetNodeNameUnion, GetSchema, PlainExtension } from '../extension';
 ...
 */
export declare type Identifiers = 'nodes' | 'marks' | 'all' | readonly string[] | IdentifiersObject;
/**
