import type { AnyFunction, CommandFunction, CommandFunctionProps, EditorSchema, EmptyShape, Fragment, FromToProps, LiteralUnion, MarkType, NodeType, PrimitiveSelection, ProsemirrorAttributes, ProsemirrorNode, RemirrorContentType, Static, Transaction } from '@remirror/core-types';
...
export declare type UpdatableViewProps = 'attributes' | 'editable';
