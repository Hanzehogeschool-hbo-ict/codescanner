import type { AttributesProps, CommandFunction, CommandFunctionProps, EditorSchema, FromToProps, MarkType, MarkTypeProps, PrimitiveSelection, ProsemirrorAttributes } from '@remirror/core-types';
/**
...
interface DelayedCommandProps<Value> {
     ...
     */
    onDone: CommandFunction<EditorSchema, {
        value: Value;
    }>;
    /**
...
export declare type DelayedValue<Type> = Promise<Type> | (() => Promise<Type>);
/**
...
export declare type DelayedPromiseCreator<Value> = (props: CommandFunctionProps) => Promise<Value>;
export declare class DelayedCommand<Value> {
     ...
     */
    success(handler: CommandFunction<EditorSchema, {
        value: Value;
    }>, method?: 'push' | 'unshift'): this;
    /**
     * Add a failure callback to the handler.
     */
    failure(handler: CommandFunction<EditorSchema, {
        error: any;
    }>, method?: 'push' | 'unshift'): this;
    private runHandlers;
    /**
...
export interface ToggleMarkProps<Schema extends EditorSchema = EditorSchema> extends MarkTypeProps<Schema>, Partial<AttributesProps> {
    /**
