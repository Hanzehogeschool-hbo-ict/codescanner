import type { AnyFunction, CommandFunction, ConditionalPick, ConditionalReturnPick, EditorSchema, Flavoring, LiteralUnion, NonChainableCommandFunction, ProsemirrorAttributes, StringKey, Transaction, UnionToIntersection } from '@remirror/core-types';
 ...
 */
export declare type MapToUnchainedCommand<RawCommands extends Record<string, AnyFunction>> = {
    [Command in keyof RawCommands]: CommandShape<Parameters<RawCommands[Command]>>;
};
/**
 * A utility type which maps the chained commands.
 */
export declare type MapToChainedCommand<RawCommands extends Record<string, AnyFunction>> = {
 ...
 */
export declare type CommandsFromExtensions<Extension extends AnyExtension, Expanded extends AnyExtension = GetExtensions<Extension>> = UnionToIntersection<MapToUnchainedCommand<GetCommands<Expanded> | GetDecoratedCommands<Expanded>>>;
/**
...
export declare type UiCommandFunction = CommandFunction & UiAnnotation;
 ...
 */
export declare type UiCommandNames<Extension extends AnyExtension> = StringKey<ConditionalPick<{
...
export declare type ChainedIntersection<Extension extends AnyExtension> = UnionToIntersection<MapToChainedCommand<GetCommands<Extension> | GetDecoratedCommands<Extension>>>;
export declare type ChainedFromExtensions<Extension extends AnyExtension, Chained extends ChainedIntersection<Extension> = ChainedIntersection<Extension>> = _ChainedFromExtensions<Extension, Chained> & ((tr: Transaction) => _ChainedFromExtensions<Extension, Chained>);
declare type _ChainedFromExtensions<Extension extends AnyExtension, Chained extends ChainedIntersection<Extension> = ChainedIntersection<Extension>> = ChainedCommandProps & {
 ...
 * Utility type for pulling all the command names from a list
 */
export declare type CommandNames<Extension extends AnyExtension> = StringKey<CommandsFromExtensions<Extension>>;
/**
 ...
 * never need to provide this type as it is automatically calculated.
 */
export declare type HelpersFromExtensions<Extension extends AnyExtension, Expanded extends AnyExtension = GetExtensions<Extension>> = UnionToIntersection<MapHelpers<GetHelpers<Expanded> | GetDecoratedHelpers<Expanded>>>;
export declare type HelperAnnotation = Flavoring<'HelperAnnotation'>;
/**
 * An annotation which marks decorated helper methods for an extension.
 */
export declare type Helper<Type> = Type extends null | undefined ? Type : Type & HelperAnnotation;
/**
 ...
 */
export declare type HelperFunction<Type extends HelperAnnotation = HelperAnnotation> = AnyFunction<Type>;
 ...
 */
export declare type HelperNames<Extension extends AnyExtension> = StringKey<HelpersFromExtensions<Extension>>;
/**
 ...
 */
export declare type RemoveAny<Extension> = Extension extends Extension ? AnyExtension extends Extension ? never : Extension : never;
/**
 ...
 * never need to provide this type as it is automatically calculated.
 */
export declare type GetPlainNameUnion<Extension extends AnyExtension, Expanded extends AnyExtension = GetExtensions<Extension>> = Expanded extends AnyPlainExtension ? Expanded['name'] : never;
/**
 ...
 * never need to provide this type as it is automatically calculated.
 */
export declare type GetMarkNameUnion<Extension extends AnyExtension, Expanded extends AnyExtension = GetExtensions<Extension>> = Expanded extends AnyMarkExtension ? Expanded['name'] : never;
/**
 ...
 * never need to provide this type as it is automatically calculated.
 */
export declare type GetNodeNameUnion<Extension extends AnyExtension, Expanded extends AnyExtension = GetExtensions<Extension>> = Expanded extends AnyNodeExtension ? Expanded['name'] : never;
/**
 * Gets the editor schema from an extension union.
 */
export declare type GetSchema<Extension extends AnyExtension> = EditorSchema<LiteralUnion<GetNodeNameUnion<Extension>, string>, LiteralUnion<GetMarkNameUnion<Extension>, string>>;
declare global {
    namespace Remirror {
        /**
