 ...
 */
export declare type ExtensionConstructorProps<Options extends ValidOptions> = ConstructorProps<Options, BaseExtensionOptions>;
/**
 ...
 * actual class.
 */
interface Extension<Options extends ValidOptions = EmptyShape> extends ExtensionLifecycleMethods, Remirror.BaseExtension {
    /**
