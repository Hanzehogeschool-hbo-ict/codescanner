...
import type { EditorSchema, EditorView, MarkExtensionSpec, NodeExtensionSpec, PrimitiveSelection, ProsemirrorNode, RemirrorContentType, RenderEnvironment, Replace, Simplify, Transaction } from '@remirror/core-types';
...
import type { AnyExtension, AnyExtensionConstructor, AnyManagerStore, GetExtensions, GetMarkNameUnion, GetNameUnion, GetNodeNameUnion, GetPlainNameUnion, GetSchema, ManagerStoreKeys } from '../extension';
 ...
 */
export declare type ExtensionTemplate<Extension extends AnyExtension> = () => Extension[];
...
export declare type AnyRemirrorManager = Simplify<Replace<RemirrorManager<AnyExtension>, {
