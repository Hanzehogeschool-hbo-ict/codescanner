...
import type { AnyExtension, GetSchema } from '../extension';
...
export declare abstract class Framework<Extension extends AnyExtension = BuiltinPreset, Props extends FrameworkProps<Extension> = FrameworkProps<Extension>, Output extends FrameworkOutput<Extension> = FrameworkOutput<Extension>> implements BaseFramework<Extension> {
     ...
     */
    protected readonly getPreviousState: () => EditorState<this['~Sch']>;
    /**
     ...
     */
    protected abstract createView(state: EditorState<this['~Sch']>, element?: Element): EditorView<this['~Sch']>;
    /**
     ...
     */
    readonly onChange: (props?: ListenerProps<Extension>) => void;
    /**
     ...
     * `onChange`
     */
    protected eventListenerProps(props?: ListenerProps<Extension>): RemirrorEventListenerProps<Extension>;
    protected readonly createStateFromContent: CreateStateFromContent<Extension>;
    /**
     * Focus the editor.
     */
    protected readonly focus: (position?: FocusType | undefined) => void;
    /**
     * Blur the editor.
     */
    protected readonly blur: (position?: PrimitiveSelection | undefined) => void;
    /**
