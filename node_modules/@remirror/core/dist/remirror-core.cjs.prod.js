...
var commands = require('@remirror/pm/commands');
var coreTypes = require('@remirror/core-types');
...
var view = require('@remirror/pm/view');
var inputrules = require('@remirror/pm/inputrules');
var keymap = require('@remirror/pm/keymap');
var pasteRules = require('@remirror/pm/paste-rules');
  ...
  addCommands(props) {
    ...
    try {
      for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
        ...
        !!forbiddenNames.has(name) ?         "production" !== "production" ? coreHelpers.invariant(false, {
          code: coreConstants.ErrorConstant.DUPLICATE_COMMAND_NAMES,
  ...
  updateTagForExtension(extension) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        !isExtensionTag(tag) ?         "production" !== "production" ? coreHelpers.invariant(false, {
...
function transformExtensions(initialExtensions, settings) {
  ...
  try {
    var _loop = function _loop() {
      ...
      !duplicates ?         "production" !== "production" ? coreHelpers.invariant(false, {
