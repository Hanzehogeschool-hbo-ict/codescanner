...
function isDomNode(domNode) {
  return (coreHelpers.isObject(Node) ? domNode instanceof Node : coreHelpers.isObject(domNode) && coreHelpers.isNumber(coreHelpers.Cast(domNode).nodeType) && coreHelpers.isString(coreHelpers.Cast(domNode).nodeName));
}
/**
