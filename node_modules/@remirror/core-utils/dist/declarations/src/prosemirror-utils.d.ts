...
interface NodeEqualsTypeProps<Schema extends EditorSchema = EditorSchema> extends NodeTypesProps<Schema>, OptionalProsemirrorNodeProps<Schema> {
}
/**
 * Checks if the type a given `node` has a given `nodeType`.
 */
export declare function isNodeOfType<Schema extends EditorSchema = EditorSchema>(props: NodeEqualsTypeProps<Schema>): boolean;
interface MarkEqualsTypeProps<Schema extends EditorSchema = EditorSchema> extends MarkTypesProps<Schema>, OptionalMarkProps<Schema> {
}
/**
 ...
 */
export declare function composeTransactionSteps(transactions: Transaction[], oldState: EditorState): Transaction;
/**
 * Checks if the type a given `node` has a given `nodeType`.
 */
export declare function markEqualsType<Schema extends EditorSchema = EditorSchema>(props: MarkEqualsTypeProps<Schema>): boolean;
 ...
 */
export declare function findElementAtPosition<Schema extends EditorSchema = EditorSchema>(position: number, view: EditorView<Schema>): HTMLElement;
/**
...
interface FindSelectedNodeOfTypeProps<Schema extends EditorSchema = EditorSchema> extends NodeTypesProps<Schema>, SelectionProps<Schema> {
}
/**
 ...
 * ```
 */
export declare function findSelectedNodeOfType<Schema extends EditorSchema = EditorSchema>(props: FindSelectedNodeOfTypeProps<Schema>): FindProsemirrorNodeResult<Schema> | undefined;
export interface FindProsemirrorNodeResult<Schema extends EditorSchema = EditorSchema> extends ProsemirrorNodeProps<Schema> {
    /**
 ...
 */
export declare function chainKeyBindingCommands<Schema extends EditorSchema = EditorSchema>(...commands: Array<KeyBindingCommandFunction<Schema>>): KeyBindingCommandFunction<Schema>;
/**
 ...
 */
export declare function mergeKeyBindings<Schema extends EditorSchema = EditorSchema>(extensionKeymaps: Array<KeyBindings<Schema>>): KeyBindings<Schema>;
/**
 * This merges an array of keybindings into one keybinding with the priority
 * given to the items earlier in the array. `index: 0` has priority over `index:
 * 1` which has priority over `index: 2` and so on.
 ...
 */
export declare function mergeProsemirrorKeyBindings<Schema extends EditorSchema = EditorSchema>(extensionKeymaps: Array<KeyBindings<Schema>>): ProsemirrorKeyBindings<Schema>;
/**
 ...
 */
export declare function containsAttributes<Schema extends EditorSchema = EditorSchema>(nodeOrMark: ProsemirrorNode<Schema> | Mark<Schema>, attrs: ProsemirrorAttributes): boolean;
export {};
