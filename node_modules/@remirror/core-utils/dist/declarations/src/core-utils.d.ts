 ...
 */
export declare function isNodeType(value: unknown): value is NodeType<EditorSchema>;
/**
 * Get the node type from a potential string value.
 */
export declare function getNodeType(type: string | NodeType, schema: EditorSchema): NodeType<EditorSchema>;
/**
 * Check to see if the passed value is a MarkType.
 *
 * @param value - the value to check
 */
export declare function isMarkType(value: unknown): value is MarkType<EditorSchema>;
/**
 * Get the mark type from a potential string value.
 */
export declare function getMarkType(type: string | MarkType, schema: EditorSchema): MarkType<EditorSchema>;
/**
 ...
 * @param value - the value to check
 */
export declare function isProsemirrorMark(value: unknown): value is Mark<EditorSchema>;
/**
 * Checks to see if the passed value is a Prosemirror Editor State
 *
 * @param value - the value to check
 */
export declare function isEditorState(value: unknown): value is PMEditorState<EditorSchema>;
/**
 * Checks to see if the passed value is a Prosemirror Transaction
 *
 * @param value - the value to check
 */
export declare function isTransaction(value: unknown): value is PMTransaction<EditorSchema>;
/**
 ...
 * @param value - the value to check
 */
export declare function isTextSelection(value: unknown): value is TextSelection<EditorSchema>;
/**
 * Predicate checking whether the selection is an `AllSelection`.
 *
 * @param value - the value to check
 */
export declare function isAllSelection(value: unknown): value is AllSelection<EditorSchema>;
/**
 ...
 * @param value - the value to check
 */
export declare function isResolvedPos(value: unknown): value is PMResolvedPos<EditorSchema>;
 ...
 * @param value - the value to check
 */
export declare function isNodeSelection(value: unknown): value is NodeSelection<EditorSchema>;
 ...
 * interface.
 */
export declare type NamedStringHandlers = {
 ...
 */
export declare function getDocument(forceEnvironment?: RenderEnvironment): Document;
 ...
 */
export declare function prosemirrorNodeToDom(node: ProsemirrorNode, document?: Document): DocumentFragment;
/**
...
export declare type StringHandlerOptions = NodeStringHandlerOptions | FragmentStringHandlerOptions;
/**
 ...
 */
export declare type InvalidContentHandler = (props: InvalidContentHandlerProps) => RemirrorContentType;
