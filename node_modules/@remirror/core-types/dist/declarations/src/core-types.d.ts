...
import type { CommandFunctionProps, EditorSchema, EditorState, EditorView, Mark, ProsemirrorCommandFunction, ProsemirrorNode, ResolvedPos, Selection } from '@remirror/pm';
 ...
 */
export declare type RemirrorContentType<Schema extends EditorSchema = EditorSchema> = string | RemirrorJSON | ProsemirrorNode<Schema> | EditorState<Schema>;
export interface KeyBindingProps<Schema extends EditorSchema = EditorSchema> extends CommandFunctionProps<Schema> {
    /**
 ...
 */
export declare type KeyBindingCommandFunction<Schema extends EditorSchema = EditorSchema> = (params: KeyBindingProps<Schema>) => boolean;
/**
 * Some commonly used keybinding names to help with auto complete.
 */
export declare type KeyBindingNames = 'Enter' | 'ArrowDown' | 'ArrowUp' | 'ArrowLeft' | 'ArrowRight' | 'PageUp' | 'PageDown' | 'Home' | 'End' | 'Escape' | 'Delete' | 'Backspace' | 'Tab' | 'Shift-Tab';
/**
 ...
 */
export declare type KeyBindings<Schema extends EditorSchema = EditorSchema> = Partial<Record<KeyBindingNames, KeyBindingCommandFunction<Schema>>> & Record<string, KeyBindingCommandFunction<Schema>>;
 ...
 */
export declare type DOMOutputSpec = string | DOMOutputSpecArray;
 ...
 */
export interface NodeExtensionSpec extends Partial<Pick<NodeSpec, 'content' | 'marks' | 'group' | 'inline' | 'atom' | 'attrs' | 'selectable' | 'draggable' | 'code' | 'defining' | 'isolating' | 'parseDOM' | 'toDebugString' | 'allowGapCursor'>> {
    /**
...
export declare type NodeSpecOverride = Pick<NodeSpec, 'content' | 'marks' | 'group' | 'inline' | 'atom' | 'selectable' | 'draggable' | 'code' | 'defining' | 'isolating' | 'parseDOM'>;
/**
...
export declare type MarkSpecOverride = Pick<MarkSpec, 'inclusive' | 'excludes' | 'group' | 'spanning' | 'parseDOM'>;
/**
 ...
 */
export declare type PrimitiveSelection = Selection | FromToProps | AnchorHeadProps | number | ResolvedPos | 'start' | 'end' | 'all';
/**
 ...
 */
export declare type DynamicAttributeCreator = (nodeOrMark: ProsemirrorNode | Mark) => JsonPrimitive;
/**
 ...
 */
export declare type SchemaAttributes = Record<string, SchemaAttributesObject | string | DynamicAttributeCreator>;
export {};
