...
export declare type FileHandlerProps = FilePasteHandlerProps | FileDropHandlerProps;
...
export declare type PasteRule = FilePasteRule | TextPasteRule | NodePasteRule | MarkPasteRule;
